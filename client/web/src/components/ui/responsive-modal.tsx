...
const ResponsiveModalVariants = cva(
  cn(
    "fixed z-50 gap-4 bg-sidebar p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 overflow-y-auto",
...
export type ResponsiveModalSizes = "default" | "sm" | "lg";
